...
<div class="space-y-6">
    ...
    <div id="checkInModule">
        <button type="button" onclick="window.scrollTo(0,0); document.getElementById('checkInModal').classList.remove('hidden')"
    ...
    <div class="grid grid-cols-2 gap-4">
        <div class="glass rounded-2xl p-5 relative overflow-hidden">
            ...
            <div class="relative z-10 flex flex-col items-center justify-center py-2">
                <span class="text-4xl font-bold text-amber-500" style="font-family: 'Bebas Neue', sans-serif;">{{ $viewingUser->total_mat_hours }}</span>
