                                ...
                                <div class="flex items-center gap-2 mt-0.5">
                                    ...
                                    @elseif($member->rank === 'Green')
                                        @if($member->belt_variation === 'solid')
                                            <div class="w-10 h-3 rounded-sm bg-green-500 relative flex items-center justify-start gap-0.5 px-0.5">
                                                @for ($i = 0; $i < $member->stripes; $i++)
                                                    <div class="w-0.5 h-full bg-white"></div>
                                                @endfor
                                            </div>
                                        @elseif($member->belt_variation === 'white')
                                            <div class="w-10 h-3 rounded-sm bg-green-500 relative flex items-center pl-0.5">
                                                <div class="h-full w-4 bg-white flex items-center justify-start gap-0.5 px-0.5">
                                                    @for ($i = 0; $i < $member->stripes; $i++)
                                    ...
                                    @elseif($member->rank === 'Orange')
                                        @if($member->belt_variation === 'solid')
                                            <div class="w-10 h-3 rounded-sm bg-orange-500 relative flex items-center justify-start gap-0.5 px-0.5">
                                                @for ($i = 0; $i < $member->stripes; $i++)
                                                    <div class="w-0.5 h-full bg-white"></div>
                                                @endfor
                                            </div>
                                        @elseif($member->belt_variation === 'white')
                                            <div class="w-10 h-3 rounded-sm bg-orange-500 relative flex items-center pl-0.5">
                                                <div class="h-full w-4 bg-white flex items-center justify-start gap-0.5 px-0.5">
                                                    @for ($i = 0; $i < $member->stripes; $i++)
                                                        <div class="w-0.5 h-full bg-orange-500"></div>
                                                    @endfor
                                                </div>
                                            </div>
                                        @else
                                    ...
                                    @elseif($member->rank === 'Yellow')
                                        @if($member->belt_variation === 'solid')
                                            <div class="w-10 h-3 rounded-sm bg-yellow-400 relative flex items-center justify-start gap-0.5 px-0.5">
                                                @for ($i = 0; $i < $member->stripes; $i++)
                                                    <div class="w-0.5 h-full bg-white"></div>
                                                @endfor
                                            </div>
                                    ...
                                    @elseif($member->rank === 'Grey')
                                        @if($member->belt_variation === 'solid')
                                            <div class="w-10 h-3 rounded-sm bg-slate-300 relative flex items-center justify-start gap-0.5 px-0.5">
                                                @for ($i = 0; $i < $member->stripes; $i++)
                                                    <div class="w-0.5 h-full bg-white"></div>
                                                @endfor
                                            </div>
                                        @elseif($member->belt_variation === 'white')
                                            <div class="w-10 h-3 rounded-sm bg-slate-300 relative flex items-center pl-0.5">
                                                <div class="h-full w-4 bg-white flex items-center justify-start gap-0.5 px-0.5">
                                                    @for ($i = 0; $i < $member->stripes; $i++)
                                                        <div class="w-0.5 h-full bg-slate-300"></div>
                                                    @endfor
                                                </div>
                                            </div>
                                        @else
